...
public class Produto {
	...
	@Size(min = 4, max = 50, message = "O atributo nome deve conter no minimo 04 e no maximo 50 caracteres")
	private String nome;
	
	@NotBlank(message = "0 atributo marca é Obrigatório!")
	@Size(min = 3, max = 30, message = "O atributo marca deve conter no mínimo 03 e no máximo 30 caracteres")
